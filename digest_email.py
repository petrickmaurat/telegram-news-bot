...
FOCO_SETORIAL = {
    ...
    "baterias": (
        ...
        "(2) TECNOLOGIA e o que pode mudar o mercado: tecnologias emergentes e disruptivas "
        "(sódio-íon, estado sólido e semissólido, ferro-ar, baterias de fluxo, lítio-metal, ânodo "
        "de silício, LMFP, armazenamento de longa duração), com destaque para o ESTÁGIO DE "
        "MATURAÇÃO — laboratório, piloto, linha-piloto, primeira produção comercial, escala em GWh, "
        "prazos de comercialização — e para dados concretos de evolução (densidade Wh/kg, ciclos, "
        "segurança, custo projetado, capacidade instalada). Nota mais alta para avanço verificável "
